...
import kr.respectme.member.port.`in`.InternalCommandPort
import kr.respectme.member.port.`in`.InternalQueryPort
...
class RestInternalAdapter(private val memberUseCase: MemberCommandUseCase): InternalQueryPort, InternalCommandPort {
    ...
    override fun deleteMember(
        ...
        memberUseCase.deleteMemberByService(serviceAccountId, memberId)
    }
}